...
This extension is not a work of a single person, a lot of people tested it and contributed to it. A [list of all contributors](http://github.com/nilshoerrmann/datetime/commits/master) can be found in the commit history.

This layout of the date widget is inspired by Scott Hughes' [calendar mock-up for Symphony 2.0](http://symphony-cms.com/discuss/thread/103/) and Rowan Lewis' [calendar overlay](https://github.com/rowan-lewis/calendaroverlay/).
